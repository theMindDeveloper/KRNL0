...
- **Right-click delete**: right-click any node → `Delete` action. `boardStore.removeNode` filters the node and every edge that touches it. Mother nodes cannot be deleted — the menu item is disabled.
