/* CanvasChassis — existing ChassisLayer body, canvas-mode path.
 *
 * ADR 0008 § 2.6 / § 12 required change #5.
 *
 * Extracted from ChassisLayer/index.tsx so ChassisLayer/index.tsx can become
 * a 5-line router (canvas → CanvasChassis, station → StationChassis).
 *
 * Behaviour is 100% identical to the original ChassisLayer — ViewportPortal-
 * anchored, follows pan/zoom, decorates the mother row in flow-space.
 */
